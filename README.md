...
- An OpenAI API key (available via the OpenAI Platform)
...
1. **Clone the repository:**
   ...
   ```
   git clone https://github.com/saichandana-gamini/Extracting-Structured-Data-From-PDFs
...
Sai Chandana Gamini is a Data Engineer with over 5 years of experience building cloud-based data platforms, distributed ETL pipelines, and AI-enabled analytics solutions. With expertise in Python, LangChain, and AWS, Sai focuses on developing scalable systems that bridge the gap between raw data and actionable insights.
